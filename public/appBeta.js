...
var translateText = {
    ...
    Tiếng_Việt:["Ấn + và - để thay đổi giao diện của trang!\nBạn luôn có thể thay đổi điều này trong cài đặt","XÁC NHẬN","Trang web sẽ tối ưu hơn khi nằm ngang, vui lòng xoay thiết bị của bạn.","Ấn vào bất cứ đâu để tắt","Tài khoản","EMAIL","MẬT KHẨU","ĐĂNG NHẬP","Tạo tài khoản","Quên tài khoản?","Đăng ký Sky Music!","EMAIL","MẬT KHẨU","XÁC NHẬN MẬT KHẨU","ĐĂNG KÝ","Đăng ký Sky Music!","CODE","XÁC NHẬN","Quay lại","Đặt ại Mật khẩu!","EMAIL","GỬI ĐI","Quay lại","Nhập lại Mật khẩu!","NHẬP LẠI CODE","MẬT KHẨU MỚI","XÁC NHẬN MẬT KHẨU MỚI","GỬI ĐI","Quay lại","Cài đặt","Thay đổi thu phóng trang web","Tắt tự động full màn hình","Vô hiệu hóa thực hành khóa tiếp theo","Ẩn hoạt ảnh của nốt nhạc","Tên Nốt Nhạc Hiển Thị","Kiểm trả hỗ trơ MIDI","Thiết lập lại tất cả bài nhạc và cài đặt","Quay lại","Bài nhạc của tôi","Bài nhạc trong tài khoản","Đây là tất cả bài nhạc của bạn!","Nhập bài hát","Dưới đây là tất cả các bài hát được lưu trong tài khoản của bạn!","Tải lại","Lưu trữ tất cả các bài hát tại địa phương","Hủy","OK","Trang chính","Tải khoản","Cài đặt","Thư viện bài hát","Hỗ trợ?","Quản lý hồ sơ","Bắt đầu/Dừng ghi âm","CŨ","Quay lại","Tải bài nhạc","Chọn ngôn ngữ","Chào mừng đến với Sky Music!","Không bao giờ mở trở lại","Bật chế độ tương thích","Hiển thị Sheet","Nhạc sĩ sáng tác"],
